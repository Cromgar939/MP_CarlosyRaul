...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kmer0.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kmer0.exe: ${OBJECTFILES}
...
${OBJECTDIR}/src/Kmer.o: src/Kmer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Kmer.o src/Kmer.cpp
